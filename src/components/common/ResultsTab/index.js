  ...
  return (
    <Fragment>
      <Tabs
        style={{
          display:
            props.albums.length || props.artists.length || props.songs.length
              ? ''
              : 'none',
        }}
        align='centered'
        size='medium'>
        <CustomTab
          active={active_tab == 'albums' ? true : false}
          onClick={() => setActiveTab('albums')}>
          Álbums
        </CustomTab>
        <CustomTab
          active={active_tab == 'artists' ? true : false}
          onClick={() => setActiveTab('artists')}>
          Artistas
        </CustomTab>
        <CustomTab
          active={active_tab == 'songs' ? true : false}
      ...
      <div>
        <div style={{ display: active_tab != 'albums' ? 'none' : '' }}>
          <Columns className='columns is-mobile is-multiline'>{albums}</Columns>
        </div>

        <div style={{ display: active_tab != 'artists' ? 'none' : '' }}>
          <div className='columns is-mobile is-multiline'>Artists</div>
        </div>
